...
void transition(no::Model& model, py::array_t<int64_t, py::array::c_style | py::array::forcecast> categories,
                 py::array_t<double, py::array::c_style | py::array::forcecast> matrix, py::object &df,
