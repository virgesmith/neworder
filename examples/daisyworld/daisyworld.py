...
class DaisyWorld(no.Model):
  ...
  def __init__(self, gridsize, pct_white, pct_black):
    ...
    self.age = (self.mc.ustream(self.domain.state.size) * DaisyWorld.MAX_AGE) \
      .astype(int).reshape(self.domain.state.shape)
