...
class Population:
  ...
  def migrations(self, deltat):
    ...
    h_out = neworder.hazard_v(out_rates * deltat)
    ...
    h_intl_in = neworder.hazard_v(intl_in_rates * deltat)
    ...
    # assign a new random fractional age based on census age category
    intl_incoming.Age = intl_incoming.DC1117EW_C_AGE - neworder.ustream(len(intl_incoming))
    ...
    h_intl_out = neworder.hazard_v(intl_out_rates * deltat)
    # remove outgoing migrants
